    ...
    <div className="min-h-screen flex items-center justify-center bg-[hsl(220,20%,97%)] p-4">
      <div className="glass-card w-full max-w-sm p-6 sm:p-8 space-y-6">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[hsl(211,100%,50%)] to-[hsl(211,100%,40%)] mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
            R
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="section-header block">Email</label>
            <Input
              type="email"
              value={email}
          ...
          <div>
            <label className="section-header block">Senha</label>
            <Input
              type="password"
              value={password}
